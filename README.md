...
Stock Trading Dashboard is a simple front end dashboard for the free trading platform [Robinhood]. You're presented with your autorefreshing portfolio after logging in: (https://robinhood.com/).
